...
namespace Logica.componentes
{
    ...
    public class Curva : Componente
    {
        ...
        public Curva(Punto3d iPuntoEntrada, Punto3d iPuntoSalida, Punto3d iCentroCurva, double iRc, double iPkIni, double iPeralte, double bombeo, puntosDelEje.EjeTrazado.sentidoCurva iSentCurva, double longClotoideAnterior)
        ...
        public override double getLongitud()
        {
            ...
            if (mCentroCurvaX != getPuntoEntrada.coordenadaX)
            {
                miPendiente1 = (getPuntoEntrada.coordenadaY - mCentroCurvaY) / (getPuntoEntrada.coordenadaX - mCentroCurvaX);
                    ...
                    else if ((mCentroCurvaX > getPuntoEntrada.coordenadaX) &&
                             (mCentroCurvaY <= getPuntoEntrada.coordenadaY))
                    {
                        //cuadrante 2
