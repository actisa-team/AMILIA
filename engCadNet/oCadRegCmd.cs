...
namespace engCadNet
{
    ...
    /// <summary>
    /// REGISTRAR APP
    /// Llamada desde la Clase Comandos
    /// RegisterForDemandLoading(Assembly.GetExecutingAssembly());
    /// </summary>
    public class oCadCmdReg
    {
        ...
        public static void RegisterForDemandLoading(Assembly iAssembly)
        {
            // Get the assembly, its name and location

            //Pruebas Crear Asembly

            // OLD Assembly assem = Assembly.GetExecutingAssembly();
            Assembly assem = iAssembly;
        ...
        public static void UnregisterForDemandLoading(string iAssemblyName)
        {
            RemoveDemandLoadingEntries(true, iAssemblyName);
        }
        ...
        private static void RemoveDemandLoadingEntries(bool currentUser, string iAssemblyName)
        {
            try
            {
                // Choose a Registry hive based on the function input
                ...
                using (ack)
                {
                    ...
                    using (appk)
                    {
                        ...
                        appk.DeleteSubKeyTree(iAssemblyName);
