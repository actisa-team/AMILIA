...
namespace tadLayLogica.logica.secciones
{
    public class oZonaDoble
    {
        ...
        public dsBd.tbRoadDobleAutoviaRow iRow = null;
        ...
        public oZonaDoble(dsBd.tbRoadDobleAutoviaRow iRow_)
        {
            iRow = iRow_;
        }
        public virtual void link()
        {
            ...
            using (DocumentLock myDockLock = oCadManager.thisEditor.Document.LockDocument())
            {
                ...
                if (lwZona != null)
                {
                    ...
                    if (capaUser == null)
                    {
                        capaUser = "Tadil_Doble_" + iRow.nombre;
                    }
                    ...
                    if (color == null)
                    {
                        ...
                        using (Transaction tr = oCadManager.StartTransaction())
                        {
                            ...
                            foreach (ObjectId acObjId in acLyrTb)
                            {
                                ...
                                if (acLyrTableRecord.Name.StartsWith("Tadil_Doble_", StringComparison.InvariantCultureIgnoreCase))
                                {
