...
{
    public class oZonaDobleSinMediana
    {
        ...
        public dsBd.tbRoadDobleSinMedianaRow iRow = null;
        ...
        public oZonaDobleSinMediana(dsBd.tbRoadDobleSinMedianaRow iRow_)
        {
            iRow = iRow_;
        }
        public virtual void link()
        {
            ...
            using (DocumentLock myDockLock = oCadManager.thisEditor.Document.LockDocument())
            {
                ...
                if (lwZona != null)
                {
                    ...
                    if (capaUser == null)
                    {
                        capaUser = "Tadil_DobleSinMediana_" + iRow.nombre;
                    }
                    ...
                    if (color == null)
                    {
                        ...
                        using (Transaction tr = oCadManager.StartTransaction())
                        {
                            ...
                            foreach (ObjectId acObjId in acLyrTb)
                            {
                                ...
                                if (acLyrTableRecord.Name.StartsWith("Tadil_DobleSinMediana_", StringComparison.InvariantCultureIgnoreCase))
                                {
