...
namespace tadLayLogica.logica.valoracion
{
	...
	public class oValoracionTrazadoAlzado : IValoracionPropiedad
	{
       ...
       public oValoracionTrazadoAlzado(Polyline iTrazadoPerfil, double iValoracionTrazadoAlzadoPC)
	   {
		   mTrazadoLonPlanta = iTrazadoPerfil.Length;
		   mLstEntidades = descomponerTrazado(iTrazadoPerfil);
		...
		private List<oEntidadesAlzados> descomponerTrazado(Polyline iTrazadoPerfil)
		{


            Xrecord miXrecord = engCadNet.oXrecord.getXrecord(iTrazadoPerfil.ObjectId, "info");
            PerfilLongitudinal.Alzado miAlzado = PerfilLongitudinal.Alzado.recuperaAlzado(engCadNet.oXrecord.getStream(miXrecord));
