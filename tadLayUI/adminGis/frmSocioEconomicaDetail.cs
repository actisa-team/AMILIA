...
namespace tadLayUI.adminGis
{
    ...
    /// </summary>
    public partial class frmSocioEconomicaDetail : Form
    {
        ...
        public frmSocioEconomicaDetail (string iIdSectorCode)
        {
            InitializeComponent();
            mIdSector = iIdSectorCode;
            post_Constructor();
            traduccion();
        }
        ...
        private void post_Constructor()
        {
            ...
            ucSueloProduccionPrecio.populate();
        ...
        private void traduccion()
        {
            ...
            this.Text = name;
            lblHeader.Text = strFrmGisGeneral.ResourceManager.GetString("ui" + mIdSector);
            ...
            ucSueloProduccionPrecio.uiLbl = strFrmGisGeneral.uiSueloValoracionProduccionSuelo;
        ...
        private void bindCreate()
        {
                ...
                {
                    string miQuery = "id = '{0}' AND idCodeSector = '{1}'";
                    mBindMaster.Filter = string.Format(miQuery, Convert.ToString(mId),mIdSector);
                }

                mItemCurrentIni = ((DataRowView)mBindMaster.Current).Row.ItemArray;

                //Tabla Zona Geologica
                dsBd.tbSocioEconomicosDataTable miTb = oSingletonDsBd.getInstance.dataset.tbSocioEconomicos;
               ...
               //Detalle
                ...
                ucSueloProduccionPrecio.uiCombo.DataBindings.Add("SelectedValue", mBindMaster, miTb.idMatValorProduccionSueloColumn.ColumnName);
               ...
               if (isValidoFrm())
               {
                   if (oExtensionString.isNombreSolucionValido(ucNombre.textbox.Text))
                   {
                       if (mId == null)
                       {
                           ...
                           ((DataRowView)mBindMaster.Current)["idCodeSector"] = mIdSector;
                       }
