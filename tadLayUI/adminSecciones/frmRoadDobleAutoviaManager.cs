...
namespace tadLayUI.adminSecciones
{
   ...
   using tadLayUI.adminGis;
    ...
    public  class frmRoadDobleAutoviaManager : frmDataGrid
    {
        private Button btnLink;

        public frmRoadDobleAutoviaManager()
       :base() 
      {
            InitializeComponent();
      ...
      public override void populate()
        {
            dgv.DataSource = oDalTabRoadDobleAutovia.getTabla();
        }
      ...
      protected override void lnkNew_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
      {
          try
          {
              ...
              frmRoadDobleAutovia miFrm = new frmRoadDobleAutovia();
              miFrm.create();
              miFrm.ShowDialog();
              populate();
          }
      ...
      protected override void lnkDelete_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
      {
          try
          {
              ...
              if (miResul == DialogResult.Yes)
              {
                  ...
                  oDalTabRoadDobleAutovia.deleteById(miId);
        ...
        private void btnLink_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                oZonaDoble miAdecacion = new oZonaDoble(oDalSecciones.getRoadDoble(id));
